...
var _a$1;
var decoders = (_a$1 = {},
    _a$1[CODEC.SECRET] = function (val) { return toHexString(val.consume(20)); },
    _a$1[CODEC.RAW] = function (val) { return toHexString(val.consume(32)); },
    _a$1[CODEC.TZ1] = tz1Decoder,
    _a$1[CODEC.BRANCH] = branchDecoder,
    _a$1[CODEC.ZARITH] = zarithDecoder,
    _a$1[CODEC.PUBLIC_KEY] = publicKeyDecoder,
    _a$1[CODEC.PKH] = pkhDecoder,
    _a$1[CODEC.DELEGATE] = delegateDecoder,
    _a$1[CODEC.INT32] = int32Decoder,
    _a$1[CODEC.SCRIPT] = scriptDecoder,
    _a$1[CODEC.BALLOT_STATEMENT] = ballotDecoder,
    _a$1[CODEC.PROPOSAL] = proposalDecoder,
    _a$1[CODEC.PROPOSAL_ARR] = proposalsDecoder,
    _a$1[CODEC.PARAMETERS] = parametersDecoder,
    _a$1[CODEC.ADDRESS] = addressDecoder,
    _a$1);
...
var _a;
var encoders = (_a = {},
    _a[CODEC.SECRET] = function (val) { return val; },
    _a[CODEC.RAW] = function (val) { return val; },
    _a[CODEC.TZ1] = tz1Encoder,
    _a[CODEC.BRANCH] = branchEncoder,
    _a[CODEC.ZARITH] = zarithEncoder,
    _a[CODEC.PUBLIC_KEY] = publicKeyEncoder,
    _a[CODEC.PKH] = pkhEncoder,
    _a[CODEC.DELEGATE] = delegateEncoder,
    _a[CODEC.SCRIPT] = scriptEncoder,
    _a[CODEC.BALLOT_STATEMENT] = ballotEncoder,
    _a[CODEC.PROPOSAL] = proposalEncoder,
    _a[CODEC.PROPOSAL_ARR] = proposalsEncoder,
    _a[CODEC.INT32] = int32Encoder,
    _a[CODEC.PARAMETERS] = parametersEncoder,
    _a[CODEC.ADDRESS] = addressEncoder,
    _a);

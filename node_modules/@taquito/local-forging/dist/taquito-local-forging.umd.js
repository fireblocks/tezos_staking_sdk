(function (global, factory) {
  ...
  var decodeCombPair = function (val) {
      var array = new Uint8ArrayConsumer(extractRequiredLen(val));
      var args = [];
  ...
  var zarithEncoder = function (n) {
      var fn = [];
      var nn = new BigNumber__default['default'](n, 10);
      if (nn.isNaN()) {
  ...
  var zarithDecoder = function (n) {
      ...
      var num = new BigNumber__default['default'](0);
  ...
  ***************************************************************************** */
  ...
  var _a$1;
  var decoders = (_a$1 = {},
      _a$1[exports.CODEC.SECRET] = function (val) { return toHexString(val.consume(20)); },
      _a$1[exports.CODEC.RAW] = function (val) { return toHexString(val.consume(32)); },
      _a$1[exports.CODEC.TZ1] = tz1Decoder,
      _a$1[exports.CODEC.BRANCH] = branchDecoder,
      _a$1[exports.CODEC.ZARITH] = zarithDecoder,
      _a$1[exports.CODEC.PUBLIC_KEY] = publicKeyDecoder,
      _a$1[exports.CODEC.PKH] = pkhDecoder,
      _a$1[exports.CODEC.DELEGATE] = delegateDecoder,
      _a$1[exports.CODEC.INT32] = int32Decoder,
      _a$1[exports.CODEC.SCRIPT] = scriptDecoder,
      _a$1[exports.CODEC.BALLOT_STATEMENT] = ballotDecoder,
      _a$1[exports.CODEC.PROPOSAL] = proposalDecoder,
      _a$1[exports.CODEC.PROPOSAL_ARR] = proposalsDecoder,
      _a$1[exports.CODEC.PARAMETERS] = parametersDecoder,
      _a$1[exports.CODEC.ADDRESS] = addressDecoder,
      _a$1);
  ...
  var _a;
  var encoders = (_a = {},
      _a[exports.CODEC.SECRET] = function (val) { return val; },
      _a[exports.CODEC.RAW] = function (val) { return val; },
      _a[exports.CODEC.TZ1] = tz1Encoder,
      _a[exports.CODEC.BRANCH] = branchEncoder,
      _a[exports.CODEC.ZARITH] = zarithEncoder,
      _a[exports.CODEC.PUBLIC_KEY] = publicKeyEncoder,
      _a[exports.CODEC.PKH] = pkhEncoder,
      _a[exports.CODEC.DELEGATE] = delegateEncoder,
      _a[exports.CODEC.SCRIPT] = scriptEncoder,
      _a[exports.CODEC.BALLOT_STATEMENT] = ballotEncoder,
      _a[exports.CODEC.PROPOSAL] = proposalEncoder,
      _a[exports.CODEC.PROPOSAL_ARR] = proposalsEncoder,
      _a[exports.CODEC.INT32] = int32Encoder,
      _a[exports.CODEC.PARAMETERS] = parametersEncoder,
      _a[exports.CODEC.ADDRESS] = addressEncoder,
      _a);
